...
export class SchemaRegistry {
    ...
    dmlFiles;
    tableCache = new Map();
    masterDataCache = new Map();
    fullSchema = null;
    ddlExtractor = new DdlExtractor();
    dmlExtractor = new DmlExtractor();
    constructor(sqlDirs) {
    ...
    /** 単テーブルのDMLを遅延パースして返す */
    async getMasterDataForTable(name) {
    ...
    async ensureFullSchema() {
        ...
        const masterData = allDmlSqls.length > 0 ? await this.dmlExtractor.extractMultiple(allDmlSqls) : [];
