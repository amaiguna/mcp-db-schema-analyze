 ...
 */
export function scanSqlDirs(dirs) {
    const ddlFiles = new Map();
    const dmlFiles = new Map();
...
function collectSqlEntries(dir, target) {
...
//# sourceMappingURL=sql-file-scanner.js.map